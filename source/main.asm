...
TempArray: .db 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96, 100, 104, 108, 112, 116
ARRAYSIZE: .db 24
...
findTempLEDS:
    ...
    ldi ZH, HIGH(TempArray*2) ; 'Times two' to align with the lpm command
    ldi ZL, LOW(TempArray*2)
